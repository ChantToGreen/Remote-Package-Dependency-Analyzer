 ...
 * Maintenance History:
 * --------------------
 * 10/18/2018 refactor from Dr Jim Fawcett's package
 * ver 1.0 : 10/18/2018
 * - first release
 *
 */
...
namespace CodeAnalysis
{
    ...
    // - aliasTable stores the aliases across files
    ...
    public class Repository
    {
        ...
        //List<CsEdge<CsNode<List<CsEdge<string,string>>,string>, string>> dummy {get;set;}
        ...
        public void addTypes(List<TypeInfo> ti,string type)
        {
            ...
            {
                typeTable.typeTable_.Add(type, ti);
            }
        }
    ...
    public class CollectMember : AAction
    {
        ...
        public override void doAction(ITokenCollection semi)
        {
            Console.WriteLine("{0} try to add dep {1}", currentNode_.name, semi[0]);
    ...
    public class CollectReturn : AAction
    {
        ...
        public override void doAction(ITokenCollection semi)
        {
            ...
            //Console.WriteLine("{0} attempt to add type {1}", currentNode_.name, semi[2]);
            int i = 2;
            while(i<semi.size())
            {
                StringBuilder type = new StringBuilder();
                ...
                //Console.WriteLine("{0} try to add type {1}", currentNode_.name, type.ToString());
    ...
    public class CollectNew : AAction
    {
        ...
        public override void doAction(ITokenCollection semi)
        {
            ...
            //Console.WriteLine("Collect new type: {0}", type.ToString());
            repo_.AddDep(type.ToString(), ref currentNode_);
